  ...
  return (
    <div className='px-4 sm:px-20 xl:px-32 my-24'>
        <div className='text-center '>
            ...
            <p className=' text-gray-600 max-w-lg mx-auto'>Explore our suite of AI-powered tools designed to help you create, edit, and enhance your content effortlessly.</p>
        </div>
        <div className='flex flex-wrap justify-center mt-10'>
        {AiToolsData.map((tool, index)=> (
            <div key={index} className='p-8 m-4 max-w-xs rounded-lg bg-[#FDFDFE] 
            shadow-lg border border-gray-200 hover:-translate-y-1 transition-all duration-300
