...
const WriteArticle = () => {
  const articleLength = [
    ...
    { length: 1200, text: "Medium (1000-1200 words)" },
    ...
    <div className="h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4">
      ...
      >
        ...
        <button disabled={loading}
          className="mt-6 w-full bg-gradient-to-r from-[#4e2685] to-[#4A7AFF] text-white px-4 py-2 rounded-lg cursor-pointer flex items-center justify-center text-sm"
          type="submit"
        >
          {
      ...
      <div className="w-full max-w-lg p-4 bg-white border border-gray-200 rounded-lg flex flex-col min-h-96 max-h-[600px]">
        <div className="flex items-center gap-3">
          <Edit className="w-5 h-5 text-[#7935aa]" />
        ...
        {!content ? (
          ...
          <div className="text-sm flex flex-col gap-3 items-center text-gray-400">
            ...
            <p>
              No article generated yet. Please enter the topic and length to
              generate an article.
            </p>
          </div>
        </div>
